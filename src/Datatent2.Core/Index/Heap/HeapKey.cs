...
namespace Datatent2.Core.Index.Heap
{
    ...
    internal readonly struct HeapKey : IEquatable<HeapKey>
    {
        public static HeapKey Empty => new HeapKey(HeapKeyType.Empty); 
        ...
        public HeapKey(HeapKeyType type)
        {
            Type = type;
            DataLength = 0;
        ...
        {
            return Type == other.Type && PageAddress.Equals(other.PageAddress);
        }

        public override bool Equals(object? obj)
        {
            return obj is HeapKey other && Equals(other);
        }

        public override int GetHashCode()
        {
            return HashCode.Combine((int)Type, PageAddress);
        }
    }
}